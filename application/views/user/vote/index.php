<?php
    if (!isset($this->session->id_pemilih)){
      redirect('/login');
    }else{
      ?>
        <!DOCTYPE html>
        ...
        <body>
          ...
          <div class="container">
            <?php 
              if ($this->session->pilih === 'y') {
                ?>
                <form action="vote/harapan" method="post">
                   <div class="form-group">
                    <label for="exampleFormControlTextarea1">Harapan untuk calon</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="harapan"></textarea>
                   </div>
